...
import MainVideo from '../assets/videoplayback.mp4';
        ...
        <VideoContainer>
            ...
            <Title variants={container} initial='hidden' animate='show'>
                <div>
                    ...
                    <motion.h1 variants={item} data-scroll data-scroll-delay="0.06" data-scroll-speed='4'>W</motion.h1>
                    <motion.h1 variants={item} data-scroll data-scroll-delay="0.04" data-scroll-speed='4'>A</motion.h1>
                </div>
                <motion.h2 variants={item} data-scroll data-scroll-delay="0.04" data-scroll-speed='2'>
                Start Your Baloot Journey..
                </motion.h2>
            </Title>
